...
public class MultiSpinner extends TextView implements OnMultiChoiceClickListener {
    ...
    private String mDefaultText = "None";
    private String mAllText = "Multi";
    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    refreshSpinner();
                    if (mListener != null) mListener.onItemsSelected(mSelected);
                    dialog.dismiss();
                }
            });
...
Log.d("MULTISPINNER",spinnerText==null?"NULL":spinnerText);
        setText(spinnerText);
    }
